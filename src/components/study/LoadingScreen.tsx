...
const tips: { title: string; body: string }[] = [
  ...
  { title: "The Difficulty Curve", body: "Most students study all lecture content the same way. But the cognitive effort required isn't equal across Bloom's levels — each level up is genuinely harder than the last, not just different. Remembering a definition takes seconds. Understanding why it works takes focused effort. Analyzing relationships between concepts can take hours of deliberate practice. Evaluating competing theories requires mastery of everything below it. NebulaLearn identifies where each moment sits so you can allocate your study time where it actually matters." },
  ...
  { title: "Why Higher Levels Feel Hard", body: "The jump from Understand to Analyze catches most students off guard. You can explain what a concept is, feel confident about it — and then completely freeze when asked to compare it to something else or identify when it breaks down. That's not a knowledge gap. That's a cognitive level gap. Higher-order thinking requires more than knowing the material — it requires holding multiple ideas in your head simultaneously and reasoning about their relationships. That's genuinely harder, and it takes deliberate practice to get there." },
];
