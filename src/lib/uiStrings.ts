...
export const UI_STRINGS = [
  ...
  "Step Ordering Mode",
  "Proof Mode",
  "Quiz only on flashcards with a formula, using formula-specific question patterns (write the formula, identify a variable, pick the right one for a scenario).",
  "Show shuffled steps for a procedure. Drag them into the correct order, then submit to see what you got right and the reasoning behind each step.",
  "Multiple-choice proof drills: justify a step, predict the next line, spot the flaw, or pick the right strategy. Always shows the full explanation, plus the annotated proof at the end.",
  "This lecture does not contain proof-based content.",
  "{n} formula card in this deck.",
  "{n} formula cards in this deck.",
  "{n} step-sequence card in this deck.",
  "{n} step-sequence cards in this deck.",
  "{n} Analyze/Evaluate card in this deck.",
  "{n} Analyze/Evaluate cards in this deck.",
  "Question amount",
  "Bloom's levels to include",
  "Flashcards ({selected}/{total} selected)",
  "Select all",
  "Clear",
  ...
  "Step Ordering — ",
  "Formula Mode — ",
  "Quiz will run on up to {n} problem.",
  "Quiz will run on up to {n} problems.",
  "Quiz will run on up to {n} question.",
  "Quiz will run on up to {n} questions.",
  "Start Proof Mode",
  "Start Step Ordering",
  "Start Formula Quiz",
